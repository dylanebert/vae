...
def main(input_path, output_path):
    ...
    for i, w1 in enumerate(w1_words):
        ...
        if os.path.exists(os.path.join(output_path, w1)):
            continue
        with open(os.path.join(output_path, w1), 'w+') as g:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input_path', help='input words', type=str, default='data/gmc_words')
    parser.add_argument('-o', '--output_path', help='directory in which to save entailment data', type=str, default='/data/nlp/vae/entailment')
